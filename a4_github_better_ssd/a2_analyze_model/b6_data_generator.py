...
class DataGenerator:
    ...
    def load_hdf5_dataset(self, verbose=True):
        '''
        # 读取hdf5文件
        # 依赖于：hdf5_dataset_path, load_images_into_memory,
    ...
    def generate(self,
        ...
        Arguments:
            ...
            # 使用的转换方法，可以是数据增强方法，也可以是单独的resize方法
        ...
        while True:
            ...
            #########################################################################################
            # 使用yield返回
            # 返回[batch_X, batch_y_encoded]
            # [(batch,300,300,3), (batch,8732,21+4+8)]
            ret = []
...
if __name__ == '__main__':
    ...
    image_data, label_data = train_generator.__next__()

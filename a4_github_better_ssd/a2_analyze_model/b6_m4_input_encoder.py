...
@File: b6_m4_input_encoder.py
@Time: 2020-03-18 16:08
@Last_update: 2020-03-18 16:08
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
class SSDInputEncoder:
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            预测的大小列表[(38, 38), (19, 19), (10, 10), (5, 5), (3, 3), (1, 1)]
            ...
            比例列表，[0.1, 0.2, 0.37, 0.54, 0.71, 0.88, 1.05]
            ...
            偏移offsets = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5]

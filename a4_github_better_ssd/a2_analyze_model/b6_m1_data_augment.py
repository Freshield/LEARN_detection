...
@File: b6_m1_data_augment.py
@Time: 2020-02-10 14:48
@Last_update: 2020-02-10 14:48
@Desc: None
@==============================================@
@      _____             _   _     _   _       @
...
from b6_m2_box_filter import BoundGenerator, BoxFilter, ImageValidator
...
class SSDDataAugmentation:
    '''
    数据增强类，这里由于增强的方式许多，主要关注增强后的样式
    这里直接返回增强后的图像，且没有单独原图resize后的图像

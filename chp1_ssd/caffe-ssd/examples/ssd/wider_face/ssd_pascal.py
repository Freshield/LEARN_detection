...
job_name = "SSD_tiny_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "VGG_tiny_wider_face_{}".format(job_name)
...
VGGNetBody_tiny(net, from_layer='data', fully_conv=True, reduced=True, dilated=True,
    dropout=False)
